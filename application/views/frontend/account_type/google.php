...
Please, input account details to your social network, like Email, Login, Passwords, etc.
            </textarea>
        </div>
    </div>
    <div class="clear"></div>
...
<script>
    $(document).ready(function(){
        ...
        var $friends = $('input[name="friends"]');
        ...
        function calculateSummary(){
            ...
            if($comments_range_custom.is(':visible')){
                ...
                if($('input[name="comments_range"]:checked').next().text() == '1-3 comments per post'){
            ...
            if($like_range_custom.is(':visible')){
                ...
                if($('input[name="like_range"]:checked').next().text() == '1-5 like per post'){
                    price += ($posting_range_custom.val() > 40) ? 500 : 0;
                }
                else{
                    price += ($posting_range_custom.val() > 40) ? (2 * tmp) : tmp;
