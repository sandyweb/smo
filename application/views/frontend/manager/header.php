...
<div class="user_info">
    <?php echo $user->email;?>
    <?php echo HTML::anchor('main/home', HTML::image('files/template/frontend/home_icon_small.png'));?>
    <?php echo HTML::anchor('manager/index', HTML::image('files/template/frontend/logout_icon_small.png'));?>
</div>