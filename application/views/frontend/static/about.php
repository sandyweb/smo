    ...
    <section class="container_12" id="inside-pages">
        ...
        <section class="grid_9 blue2 light-shadow">
            ...
            <section class="team-list">
                <h2>Our Team</h2>
                <div class='lrg-team-photo'></div>
                <ul>
                    <li>
                        <section class="imgb">
                            <img src="<?=URL::base();?>images/img_man_shawn2.png" width="121" height="100" alt="man" />
                            <section class="clear"></section>
                        ...
                        <section class="txtb">
                            ...
                            <p>As a software architect of 13 years for Fortune 500 firms, Shawn is the author of multiple books on software development. He has worked in technical leadership roles for billion-dollar companies like First American Title, where he assessed potential target acquisitions, including one acquisition of a firm for 95 million dollars. Shawn holds a Bachelors in Business Management with certifications with Microsoft & the Project Management Institute.</p>
                        </section>
                        <section class="clear"></section>
                    </li>
                    <li>
                        <section class="imgb">
                            <img src="<?=URL::base();?>images/img_man_stan2.png" width="121" height="100" alt="man" />
                            <section class="clear"></section>
                        ...
                        <section class="txtb">
                            ...
                            <p>Stan Miroshnik is a finance executive with extensive experience in corporate finance, mergers & acquisitions, business development, and capital raising. In his prior roles, he has an Executive Vice President leading the strategy and business development team of a major international energy company, and spent a career in investment banking across New York, London and Moscow.</p>
                        </section>
                        <section class="clear"></section>
                    </li>
                    <li>
                        <section class="imgb">
                            <img src="<?=URL::base();?>images/img_man_matt2.png" id="ContentPlaceHolder1_Img2" width="121" height="100" alt="man" />
                            <section class="clear"></section>
                    ...
                    <li>
                        <section class="imgb">
                            <img src="<?=URL::base();?>images/img_man_jeff.png" width="121" height="100" alt="man" />
                            <section class="clear"></section>
                            <a target="_blank" href="https://twitter.com/SherwoodMG" title="Twitter" class="icon twitter">Twitter</a>
                            <a target="_blank" href="http://www.linkedin.com/in/sherwoodjeff" title="Linkedin" class="icon linkedin">Linkedin</a>
                        </section>
                        <section class="txtb">
            ...
            <section class="team-list">
                ...
                <ul>
                    <li>
                        <section class="imgb">
                            <img src="<?=URL::base();?>images/img_man_martin.png" id="ContentPlaceHolder1_Img1" width="121" height="100" alt="man" />
                            <section class="clear"></section>
                            <a target="_blank" href="http://http:/www.linkedin.com/in/mtantow" title="Linkedin" class="icon linkedin">Linkedin</a>
                            <a target="_blank" href="mailto:martin.tantow@gmail.com" title="Email" class="icon email">Email</a>
                        </section>
                        <section class="txtb">
                            <h3>Martin Tantow</h3>
                            <p>Martin Tantow has been an entrepreneur and investor for over 15 years. He is the founder and Managing Director at Amiro Group, which provides global insights and advice for tech entrepreneurs and investors. Martin founded CloudTimes, which quickly became a leading media property on cloud computing. He also co-founded 3scale, an API management solution and Avalas, a mobile Internet portal. Martin is a mentor with TechStars, Astia and Startupbootcamp.</p>
                        </section>
                        <section class="clear"></section>
                    </li>
                    <li>
                        <section class="imgb">
                            <img src="<?=URL::base();?>images/img_man_dean.jpg" id="ContentPlaceHolder1_Img3" width="121" height="100" alt="man" />
                            <section class="clear"></section>
                            <a target="_blank" href="http://http:/www.linkedin.com/in/deanmccall" title="Linkedin" class="icon linkedin">Linkedin</a>
                            <a target="_blank" href="mailto:dean@appficient.com" title="Email" class="icon email">Email</a>
                        </section>
                        <section class="txtb">
                            <h3>Dean McCall</h3>
