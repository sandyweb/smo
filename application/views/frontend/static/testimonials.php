<section class="wide100-testimony">
    ...
    <section class="container_12">
        <section class="grid_9 blue">
            <ul class=testimony-list>
                ...
                <li>
                    <img src="<?=URL::base();?>images/img-testimony-cody.png" width="220" height="147" alt="" />
                    <h4 class="blue f-face2">Cody Fletcher, CEO, Flip Studios</h4>
                    <p>This is a game-changer for my companies. We sent in Excel Macro development work, and without extending hardly any effort, we stood by and watched a sophisticated project management-driven arrangement take place. Hard to ever go back to personally babysitting the freelancers again.</p>
                    <div class="clear"></div>
                </li>
                <li>
        ...
        <section class="grid_3">
            <section class="testimonial-sidebar blue">
                <h1> Top Things <br />Our Customers Like:</h1>
                <p>
                    1.&nbsp;&nbsp;Solid project managers<br />
                    2.&nbsp;&nbsp;Use of multiple talent pools<br />
                    3.&nbsp;&nbsp;Easy to use<br />
                    4.&nbsp;&nbsp;Speaking real english<br />
                    5.&nbsp;&nbsp;Clean user experience<br />
                    6.&nbsp;&nbsp;Reliability of the work<br />
                    7.&nbsp;&nbsp;Fast results<br />
                    8.&nbsp;&nbsp;Well-organized projects<br />
                </p>
            </section>
        </section>
    </section>
