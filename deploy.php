 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'c97d3c703da789d38f756d97735bd1b2');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/hlboy4ik/smo.git');
 ...
 */
define('TARGET_DIR', '/var/www/ziptask/');
 ...
 * @var string Full path including the trailing slash
 */
define('TMP_DIR', '/tmp/'.REMOTE_REPOSITORY.'/');
